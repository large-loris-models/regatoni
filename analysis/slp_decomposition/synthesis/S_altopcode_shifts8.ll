...
; 8-wide alt-opcode shift bundle to push past VL.size() > SmallNodeSize=4 in
; canBuildSplitNode, which calls isShiftOp / isBitwiseLogicOp / etc.
define <8 x i32> @altshifts8(<8 x i32> %a, <8 x i32> %b) {
